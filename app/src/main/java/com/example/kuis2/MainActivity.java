...
public class MainActivity extends AppCompatActivity {
    ...
    private int totalSaldo = 0;  // Inisialisasi saldo awal
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvTransactions = findViewById(R.id.lvTransaksi);
        FloatingActionButton fabAddTransaction = findViewById(R.id.fabAddTransaksi);
